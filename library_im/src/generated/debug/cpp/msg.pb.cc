...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      Head_descriptor_, Head::internal_default_instance());
}
...
void protobuf_ShutdownFile_msg_2eproto() {
  ...
  Head_default_instance_.Shutdown();
...
void protobuf_InitDefaults_msg_2eproto_impl() {
  ...
  ::google::protobuf::internal::GetEmptyString();
  Head_default_instance_.DefaultConstruct();
  Msg_default_instance_.get_mutable()->InitAsDefaultInstance();
  Head_default_instance_.get_mutable()->InitAsDefaultInstance();
}
...
void Head::SharedCtor() {
  ...
  ::memset(&msgtype_, 0, reinterpret_cast<char*>(&statusreport_) -
    reinterpret_cast<char*>(&msgtype_) + sizeof(statusreport_));
  _cached_size_ = 0;
}
...
::google::protobuf::internal::ExplicitlyConstructed<Head> Head_default_instance_;
...
void Head::UnsafeMergeFrom(const Head& from) {
  GOOGLE_DCHECK(&from != this);
...
inline const Head* Head::internal_default_instance() {
  return &Head_default_instance_.get();
}
#endif  // PROTOBUF_INLINE_NOT_IN_HEADERS
