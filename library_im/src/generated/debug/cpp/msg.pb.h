...
class Head : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Head) */ {
 public:
  ...
  static const Head* internal_default_instance();
  ...
  void UnsafeMergeFrom(const Head& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<Head> Head_default_instance_;
